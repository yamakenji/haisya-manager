...
INSERT IGNORE INTO drivers (id, ride_id, member_id, ride_entry_id) VALUES
(1, 1, 1, 1),
(2, 1, 3, 3),
(3, 1, 8, 8),
(4, 1, 9, 9),
...
INSERT IGNORE INTO ride_member_entries (id, ride_id, member_id, driver_id) VALUES
(1, 1, 5, 1),
(2, 1, 7, 3),
(3, 3, 13, 7);

/* ride_child_entries　（配車に指定された人が乗せる子供を保存する） テーブル */
INSERT IGNORE INTO ride_child_entries (id, ride_id, child_id, driver_id) VALUES
(1, 1, 1, 1),
(2, 1, 2, 3),
(3, 1, 3, 2),
(4, 1, 4, 2),
